...
SCREEN_NAME="dl"                    # screen会话名称
WORK_DIR="/home/game/Steam/steamapps/common/dl_server"  # 工作目录
START_SCRIPT="./Dragons/Binaries/Linux/DragonsServer-Linux-Shipping"  # 启动脚本路径
PORT="7777"                              # 启动端口
QUERYPORT="27015"                        # 查询端口
SERVER_NAME="YOUR SERVER NAME"  # 服务器名称
LOG_FILE="/home/game/Steam/steamapps/common/dl_server/Dragons/Saved/Logs/Dragons.log"  # 日志文件路径
